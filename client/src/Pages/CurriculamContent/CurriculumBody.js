                            ...
                            <div className="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                                <div className="myChlidContent">
                                    ...
                                    <div className="currculumPageImg">
                                        ...
                                        <p>Little Lambs Nursery will focus on children's mental and physical well-being. Children will work on long-term skills to build a healthy foundation that they can take forward. They will develop/improve Self-Regulation; Managing Self; Building Relationships. Little Lambs Nursery will provide children with lots of social opportunities. At our nursery, we encourage our students to learn and build healthy relationships within the nursery with their peers and teachers. They’ll learn what is right and what is wrong, alongside respect and compassion. Children will develop independence and self-esteem. They will learn to play with other children as Little Lambs Nursery will assess the children on the stage of play they are in and be a facilitator to overcome the stage wherever possible.</p>
                                    ...
                                    <div className="currculumPageImg">
                                        ...
                                        <p>Little Lambs Nursery will provide opportunities for children to improve spoken language skills so that they are able to interact with their peers and their learning environment. Little Lambs Nursery will focus on the essential areas of communication and language -Listening, Attention, Understanding and Speaking. Children will learn various ways to take in information, and communicate information. They will learn to associate words and image so that there is language and communication development. Children will read lots of books so that they can make a connection between the pictures in the book and the text they’re reading out. Lots of activities to improve the communication and language of children will be conducted in the nursery, like role play, storytelling, show & tell, group games, discussions, poetry recitation, events, drama, etc</p>
                                    </div>
                                    ...
                                    <div className="currculumPageImg">
                                        ...
                                        <p>Little Lambs Nursery will provide lots of opportunities in this to develop emotive sharing. Children learn to use a range of materials and activities in order to express themselves through imaginative play. These activities include design and technology, dance, movement, music, art, and role-play. Children learn to work and explore different colours, textures, shapes, spaces and forms. Children will develop their imagination through stories and a wide variety of activities in LLN.</p>
                                    </div>

                                    <div className="currculumPageImg">
                                        <img src={socialStudy} alt="socialStudy" className="img-fluid" />
                                        <h4 className="curriculumTitle blue">Social studies</h4>
                                        <p>Little Lambs Nursery will make children study people and how they relate to each other and focus on the self-development of each child. Young children live in the present; hence they will be made to understand the meaning of the past via discussions of history, culture, geography, civic and community. In the Little Lambs Nursery classrooms, children will learn how to share and cooperate to work together and thus take turns. They will participate in group activities and learn to follow simple instructions. Children will understand the wants and needs of self, society and nation.</p>
                                    </div>

                                    <div className="currculumPageImg">
                                        <img src={stem} alt="stem" className="img-fluid" />
                                        <h4 className="curriculumTitle pink">Information Technology/STEM</h4>
                                        <p>Little Lambs Nursery will provide an IT and STEM lab to the children from toddlers onwards. Electronic technology such as tablets, electronic toys and computers, as well as off-screen resources related to science, engineering and maths like toolkits, puzzles, lego, magnetic tiles, blocks, construction materials etc., will be provided in the lab. Children will have opportunities to conduct simple experiments to understand scientific concepts. Teachers will record children's stories about their drawings or their play; make digital audio or video files to document their progress. Children will explore digital storytelling and co-create digital books with photos of the children's play or work; attach digital audio files with the child as the narrator. Little Lambs Nursery will use technology tools to support children's collaborative reasoning around STEM concepts, equalising participation among group members and helping each child and group improve their ideas</p>
                                    </div>
