                            ...
                            <div className="col-lg-9">
                                <div className="differenceBodyCard">
                                    <ul>
                                        ...
                                        <dd>Toddler- 1 year to 2 years</dd>
                                        <dd>Nursery- 2 years to 3 years</dd>
                                        ...
                                        <li>French for FS1 and FS2</li>
                                        <li>Spring, winter and summer camps</li>
                                        <li>Ongoing observations to help the child’s holistic development</li>
