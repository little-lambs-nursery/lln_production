    ...
    return (
        <>
            <section className="container-fluid p-0">
                <div className="differenceBodyBg">
                    <div className="container">
                        <div className="row d-flex justify-content-center mb-5">
                            ...
                            <div className="col-lg-9">
                                <div className="differenceBodyText">
                                    <p>With all the above create an environment where the children are happy,<br /> confident, safe and secure.</p>
                                </div>
                            </div>
                            <div className="col-lg-9">
                                <div className="differenceBodyApproachTitle">
                                    <p>Approach of Little Lambs Nursery</p>
                                </div>
                            </div>
                            <div className="col-lg-9">
                            ...
                            <div className="col-lg-9">
                                <div className="differenceBodyApproachCard">
                                    <p>Build up an innovative IT and STEM lab that works on the curiosity of the children, enhances creativity, improves eye-hand coordination and promotes spatial skills.</p>
                                </div>
                            </div>
                        </div>
                    </div>
